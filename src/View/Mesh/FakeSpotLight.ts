...
export class FakeSpotLight extends THREE.Object3D {
    ...
    constructor(params: FakeSpotLightParameter = FakeSpotLight.defaultParameter) {
        ...
        const { radius, height, color1, color2, position, rotation, anglePower, attenuation } = params;
        ...
        const geometry = new THREE.CylinderGeometry(0.1, radius, height, 32 * 2, 20, false);
    ...
    public addToDebugUI(debugUI: DebugUI) {
        ...
        const rad = debugUI.addInput(this, "radius").on("change", () => {
            (this.children[0] as any).geometry = new THREE.CylinderGeometry(0.1, this.radius, this.height, 32 * 2, 20, false);
        })
