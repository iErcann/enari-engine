...
import { AnimationMarker, AnimationMarkerDelimiter } from '../../Interface/utils'
...
export class AnimatedLoadableMesh extends LoadableMesh implements IUpdatable {
  ...
  public playAnimation(animationName: string, loop = false, selfInterrompable = true) {
    const animationMarker: AnimationMarkerDelimiter = this.animations.get(animationName)!
