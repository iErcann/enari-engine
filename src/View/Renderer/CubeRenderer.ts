...
export class CubeRenderer extends CubeCollider implements IUpdatable {
    ...
    constructor(position: Vector3D, rotation: Vector3D, size: Vector3D, mass: number, material?: THREE.Material | THREE.Material[]) {
        ...
        const geometry: THREE.BoxBufferGeometry = new THREE.BoxBufferGeometry(size.x, size.y, size.z);
